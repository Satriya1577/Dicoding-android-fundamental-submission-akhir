...
import com.example.mydicoding.databinding.ActivityDetailBinding
...
class DetailActivity : AppCompatActivity() {
    ...
    val factory: com.example.mydicoding.ui.ViewModelFactory = com.example.mydicoding.ui.ViewModelFactory.getInstance(this)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.findDetailEvents(intent.getIntExtra("EVENT_ID", -1).toString()).observe(this) { result ->
            ...
            viewModel.getFavoriteEventById(intent.getIntExtra("EVENT_ID", -1).toString()).observe(this) { favEvent ->
                if (favEvent == null) {
                    ...
                    binding?.btnFavorite?.setImageResource(R.drawable.ic_heart_full)
                    isEventExist = true
                }
            }
        }
        ...
        val settingsViewModel = ViewModelProvider(this,
            com.example.mydicoding.ui.navigation.settings.ViewModelFactory(pref)
