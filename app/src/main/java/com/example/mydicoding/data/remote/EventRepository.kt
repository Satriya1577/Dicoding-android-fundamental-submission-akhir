package com.example.mydicoding.data.remote
...
import com.example.mydicoding.data.local.database.FavoriteEventDao
import com.example.mydicoding.data.local.database.FinishedEvent
import com.example.mydicoding.data.local.database.FinishedEventDao
import com.example.mydicoding.data.local.database.UpcomingEvent
import com.example.mydicoding.data.local.database.UpcomingEventDao
import com.example.mydicoding.data.remote.response.DetailEventResponse
import com.example.mydicoding.data.remote.response.Event
import com.example.mydicoding.data.remote.retrofit.ApiService
